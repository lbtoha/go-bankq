        ...
        <div className=" container ">
          <div className="grid grid-cols-1 justify-between gap-6 max-lg:space-y-4 lg:grid-cols-2">
            <div>
              ...
              <h3
                className={`mb-4 mt-5 max-w-[416px] font-montserrat text-[25px] font-semibold leading-[120%] text-sub-title-color md:mt-7 lg:mb-6 lg:mt-10 lg:text-[30px] xl:text-[32px]`}
              >
            ...
            <div>
              ...
              <h3 className="mb-4 mt-5 font-montserrat text-[25px] font-semibold leading-[120%] text-sub-title-color md:mt-7 lg:mb-6 lg:mt-10 lg:text-[30px] xl:text-[32px]">
