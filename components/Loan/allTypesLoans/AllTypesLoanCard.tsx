  ...
  return (
    <div className="max-sm:mx-2">
      <div className="border-with-gray-bg group custom-transition rounded-xl p-4 even:mt-[80px] hover:bg-primary-color-2 sm:me-4 md:p-[30px]">
        <span className="material-symbols-outlined custom-transition rounded-full bg-[#E7E9EE] p-[15px] text-primary-color-1 group-hover:bg-primary-color-2.2 group-hover:bg-white group-hover:bg-opacity-20 max-md:text-3xl md:text-[50px]">
          {iconName}
        </span>
        <h3
