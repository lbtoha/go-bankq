...
export const GoBank = () => {
  return (
    <section className="relative">
      <div className="section-gap container max-sm:px-2 ">
        <div className="md:w-[516px]">
          <h3 className="mb-[25px] text-[40px] font-bold text-primary-color-2">
            <span className="text-neutral-color-neutral-800 ">Why</span> GoBank
          </h3>
          <p className="text-base leading-[150%] text-neutral-color-neutral-600 md:text-lg">
      ...
      <div className=" absolute hidden h-[50%] w-[40%] bg-primary-color-2 bg-opacity-10 lg:block"></div>
    </section>
  );
};
